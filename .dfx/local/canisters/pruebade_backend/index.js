...
import { idlFactory } from './pruebade_backend.did.js';
export { idlFactory } from './pruebade_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PRUEBADE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./pruebade_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the pruebade_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./pruebade_backend.did.js")._SERVICE>}
 */
export const pruebade_backend = createActor(canisterId);
